...
test_that("Cat likelihood works", {
  ...
  # 2-Way Calls
  expect_identical(llcat(x, p), ll(x, p, D))
...
test_that("Cat estim works", {
  ...
  # Types
  expect_true(is.numeric(ecat(x, dim = 4, type = "mle")))
  expect_true(is.numeric(ecat(x, dim = 4, type = "me")))

  # 2-Way Calls
  expect_identical(ecat(x, type = "mle", dim = 4), estim(x, D, type = "mle"))
  expect_identical(ecat(x, type = "me", dim = 4), estim(x, D, type = "me"))
