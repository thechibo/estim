...
\begin{figure}[t!]
\centering
<<vis_small_beta, echo=FALSE, fig=TRUE, height=6, width=15>>=
...
\begin{figure}[t!]
\centering
<<vis_large_beta, echo=FALSE, fig=TRUE, height=6, width=15>>=
...
\pkg{estim}~\Sexpr{packageVersion("estim")} package. \proglang{R} itself
