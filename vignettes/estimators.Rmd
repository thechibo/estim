...
The `estimators` package offers a few convienient functions for parameter estimation in statistics. This guide provides an overview of the package's capabilities.
